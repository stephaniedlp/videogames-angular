...
export const listaDummy: Videojuegos[] = [
    {
      id: 1000,
      estatus: JuegoEstatu.Disponible,
      modelo: 'Casa Alfa',
    ...
    {
      id: 5000,
      estatus: JuegoEstatu.Negociacion,
      modelo: 'Casa Alfa',
      imagen: 'real-estate-1.jpg',
